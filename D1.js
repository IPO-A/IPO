...
🆔 الرقم المرجعي: ${refNumber}`;
  ...
  if (method === 'wallet') {
    response.innerHTML = `
      ✅ تم إرسال البيانات بنجاح.<br>تواصل معنا للحصول على رابط المحفظة وتوثيق حسابك </br>
      <strong>https://t.me/Muhamad_AlOsaimi</strong>
    `;
  } else if (method === 'bank') {
    response.innerHTML = `
      ✅ تم إرسال البيانات بنجاح.<br> تواصل معنا للحصول على رقم البنكي وتوثيق حسابك:<br>
      <strong>https://t.me/Muhamad_AlOsaimi</strong>
    `;
  }
